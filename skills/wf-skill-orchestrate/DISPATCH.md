...
2. **Verify gate.** If the transition requires a gate (human approval), confirm the gate has been passed.
...
9. **Gate check.** If the new state requires a gate, present the gate to the human and wait.
